CREATE DATABASE IF NOT EXISTS `ncrelay`;
USE `ncrelay`;
...
CREATE TABLE IF NOT EXISTS `level_node` (
    ...
    `level_cluster` VARCHAR(20) NOT NULL DEFAULT '0',
    `level_type` VARCHAR(20) NOT NULL,
    `plevel_id` VARCHAR(100) NOT NULL,
    PRIMARY KEY (`id`),
    UNIQUE KEY (`level_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8
